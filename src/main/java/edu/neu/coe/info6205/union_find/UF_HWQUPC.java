...
public class UF_HWQUPC implements UF {
    ...
    public static int count(int n) {
        // count the number of random generated connections until only 1 component left
        int num = 0;
        UF_HWQUPC x = new UF_HWQUPC(n);
        while (x.components() != 1) {
    ...
    public static void main(String[] args) {
        for (int n = 10; n < 50000; n *= 2) {
            int num = count(n);
            System.out.println("n: " + n + ", number of generated connections: " + num);
        }
    }
